...
import {HeaderContainer, LogoContainer, OptionLink, OptionsContainer, ImageStyles} from './header.styles';
...
<HeaderContainer>
    ...
    <OptionsContainer>
        ...
        {
            currentUser ? <OptionLink as='div' onClick={()=> auth.signOut()}>LOG OUT</OptionLink>
            :
            <OptionLink to='/login'>
            LOG IN
            </OptionLink>
